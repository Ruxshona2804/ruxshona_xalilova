...
const Contact = () => {
    ...
    return (
        <div className="container  flex items-center  h-[800px] text-white">
            <p className="text-[50px] w-[50%]  font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-transparent bg-clip-text">
  ...
  <div className="bg-[#0e0e1a] rounded-2xl p-6 text-white space-y-4">
    {[
      ...
      <a
        ...
        className="flex items-center gap-4 px-6 py-4 rounded-xl bg-[#141426] hover:bg-[#1c1c31] transition duration-300 text-lg md:text-xl"
      >
